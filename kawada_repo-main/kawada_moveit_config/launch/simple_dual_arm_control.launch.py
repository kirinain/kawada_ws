...
def generate_launch_description():
    ...
    # 9. Cartesian Control Publishers (simplified)
    ...
    delayed_publishers = TimerAction(period=12.0, actions=[right_arm_cartesian_publisher, left_arm_cartesian_publisher])
